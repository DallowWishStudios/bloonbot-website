...
export default () => {
    ...
    var bot = {
        ...
        cp: {
            ...
            init() {
                const body = document.querySelector(bot.bbte ? '.BBTE' : 'body');
            ...
            stylize() {
                ...
                .temp-update-name:focus {
                    border-bottom: 1px solid #fff;
                }
                
                /* .temp-update-name::after {
                    content: '';
                    background: #fff;
                    height: 1px;
                    width: 100%;
                ...
                .temp-updating-editables {
                    margin-top: 3px;
                    display: flex;
                }
                
                .update-toolbar .private-switch {
                    cursor: pointer;
                    fill: #666;
                }
                
                .update-toolbar .private-switch.true {
                    fill: #fff;
                }
                
                #botPanel input, #botPanel textarea {
                    box-sizing: border-box;
                }
                ...
                .hide-section-btn:hover > svg {
                    fill: #bbb !important;
                }
                
                .section-container.off > .section-content {
                    display: none;
                }
                
                .section-container.off > .hide-section-btn {
                    color: #888;
                }
                
                .section-container.off > .hide-section-btn > svg {
                ...
                .bot--expimp .bot-svg-icon {
                    height: 130%;
                    margin-right: 0;
                    fill: inherit;
                }
                
                .import-top > *, .bot--export-div > * {
                    margin-bottom: 5px;
                }
                ...
                .bot--export-div, .bot--import-div {
                    position: relative;
                    width: 50%;
                }
                
                .bot--export-div .bot--btn {
                    background: #f88;
                    color: #800;
                }
                ...
                .bot-warning {
                    background: rgba(236, 178, 18, 0.356);
                    padding: 8px;
                    font-size: 0.8rem;
                    margin-bottom: 8px;
                    display: flex;
        ...
        leaveIfDisconnected() {
            if (this.btn.classList.contains(this.inactiveSendBtnClass) && this.isAutoNext) {
                this.btnEsc.click();
    ...
    bot.init({
        inputQuery: '.me .msgInput',
        sendBtnQuery: '.me .send',
        disconnectBtnQuery: '.me .disconnect',
        msgLogQuery: '.chat .log',
        strangerMsgClass: 'str',
        lastStrangerMsgQuery: '.str:last-of-type .msg',
        isReact: true,
        inactiveSendBtnClass: 'disabled'
    });
